...
class DataResponse<TModel>{
  ...
  DataResponse({this.isSuccess, this.error, this.message,this.unread_notification, this.data, this.code, this.apiStatus,this.main_data, this.token, this.hasBusiness,this.is_favourite});
